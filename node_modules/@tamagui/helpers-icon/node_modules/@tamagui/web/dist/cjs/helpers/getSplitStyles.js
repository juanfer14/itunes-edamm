...
function isValidStyleKey(key, staticConfig) {
  const validStyleProps = staticConfig.validStyles ?? (staticConfig.isText ? import_helpers.stylePropsText : import_helpers.validStyles);
...
const getSplitStyles = (props, staticConfig, theme, themeName, componentState, styleProps, parentSplitStyles, context, elementType, debug) => {
  ...
  for (const keyOg in props) {
    ...
    if (valInitType === "string" && valInit[0] === "_" && (isValidStyleKeyInit || keyInit.includes("-"))) {
