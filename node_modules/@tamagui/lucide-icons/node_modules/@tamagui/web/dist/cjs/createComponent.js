...
let tamaguiConfig, initialTheme, time, debugKeyListeners, startVisualizer;
...
function createComponent(staticConfig) {
  ...
  (0, import_config.onConfiguredOnce)((conf) => {
    ...
    if (config = conf, staticConfig.componentName) {
      const defaultForComponent = (_a2 = conf.defaultProps) == null ? void 0 : _a2[staticConfig.componentName];
  ...
  const component = (0, import_react.forwardRef)((propsIn, forwardedRef) => {
    ...
    const isAnimatedReactNative = hasAnimationProp && (animationsConfig == null ? void 0 : animationsConfig.isReactNative), isReactNative = !!(staticConfig.isReactNative || isAnimatedReactNative), shouldAvoidClasses = !!(!import_constants.isWeb || isAnimated || !staticConfig.acceptsClassName || propsIn.disableClassName), shouldForcePseudo = !!propsIn.forceStyle, noClassNames = shouldAvoidClasses || shouldForcePseudo, disableTheme = props["data-disable-theme"] && !willBeAnimated || isHOC;
...
If you meant to do this, you can disable this warning - either change untilMeasured and group at the same time, or do group={conditional ? 'name' : undefined}`
    ...
    )), !isReactNative && !asChild ? viewProps = (_h = (_g = import_setupHooks.hooks).usePropsTransform) == null ? void 0 : _h.call(_g, elementType, nonTamaguiProps, hostRef) : viewProps = nonTamaguiProps;
...
` && console.error(
    ...
    const groupState = stateRef.current.group, subGroupContext = (0, import_react.useMemo)(() => {
